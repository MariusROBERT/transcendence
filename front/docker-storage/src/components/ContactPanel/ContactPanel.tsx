...
export function ContactPanel({ meUser, viewport, setUserComplete }: Props) {
		...
		<>
			<div style={{ height: viewport.height - 100 + 'px', width: '100%' }}>
				<Background flex_gap={'1px 0px'} flex_alignItems={'stretch'} flex_justifyContent={'flex-start'}>
					...
					<GroupItems setUserComplete={setUserComplete} meUser={meUser} heading={'Friends'} duration_ms={900}/>
					<GroupItems setUserComplete={setUserComplete} meUser={meUser} heading={'Groups'} duration_ms={900}/>
					<GroupItems setUserComplete={setUserComplete} meUser={meUser} heading={'Last Chat'} duration_ms={900}/>
